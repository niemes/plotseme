...
function processing($sketch_path, $width="100px", $height="100px"){
	
	$html = "[html]";
	$html .= "<script src=\"js/processing.js\" type=\"text/javascript\"></script>";
	$html .= "<script type=\"text/javascript\">";
	$html .= "function getProcessingSketchId () { return '".$sketch_path."'; }\r";
	$html .= "</script>";
	$html .= "<canvas id=\"".$sketch_path."\" data-processing-sources=\"".$sketch_path."\" width=\"".$width."\" height=\"".$height."\">\r";
