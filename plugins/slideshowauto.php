...
$parser->add_tag("slideshowauto", "#\[slideshowauto\](.*?)\[/slideshowauto\]#sie", "slideshowauto('\\1')"); //image [img]http://www.somewere.com/image.png[/img]


function slideshowauto($path){
	//$file_array[] = array();
	...
	$html .="objcounter = document.getElementById(id+'_counter');\r";
	$html .="objcounter.innerHTML= obj.index+1 + '/' + obj.length_diapo;\r";
	$html .="setTimeout(\"slide_auto()\", tempo);\r";
	$html .="}\r";
	$html .="function slide_auto() {\r";
	$html .="slide_next('".$path."');\r";
	$html .="setTimeout(\"slide_auto()\", tempo);\r";
	$html .="}\r";
	$html .="}\r";
